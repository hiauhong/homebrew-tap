class Remindkit < Formula
  ...
  on_arm do
    url "https://github.com/hiauhong/remindkit-cli/releases/download/v0.3.4/remindkit-darwin-arm64.tar.gz"
    sha256 "3e616cd3b359c1bbfa008124e4cca295c8b435970a9f2bed5b788280296cbf8b"
  end
