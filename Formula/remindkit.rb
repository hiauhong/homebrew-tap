class Remindkit < Formula
  ...
  on_arm do
    url "https://github.com/hiauhong/remindkit-cli/releases/download/v0.1.2/remindkit-darwin-arm64.tar.gz"
    sha256 "37a188392275f657ee9b93839ee2a010fafa76c960e1fcee6290cb09a84bc65e"
  end
