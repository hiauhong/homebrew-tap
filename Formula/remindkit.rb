class Remindkit < Formula
  ...
  on_arm do
    url "https://github.com/hiauhong/remindkit-cli/releases/download/v0.2.7/remindkit-darwin-arm64.tar.gz"
    sha256 "27914570d052fad229908870f31732efee8f531b7aefe83684f9d9d1d09beaf2"
  end
